...
@section('title', 'FlyOFair | Contáctanos')
...
<section class="innerbanner-section">
    <div class="innerbannerbg">
        <img src="{{ asset('images/banner/contact-banner.jpg') }}" alt="">
    </div>
    <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-5">
                    <div class="contact-img-box">
                        <img src="{{ asset('images/contact-us image.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
                <!-- Contact Form -->
                <div class="col-lg-7">
                    <form id="contactForm" class="custom-contact-form">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="subject" class="form-control custom-input" placeholder="Tu Asunto" required>
                            </div>
                            <div class="col-12">
