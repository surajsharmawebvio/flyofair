...
function initializeTravelerForm() {
    ...
    setTimeout(() => {
        ...
        $('.flight-guest-input').each(function (index) {
            ...
            $card
                .find('input[name="travelClass"]')
                .off('change.traveler')
                .on('change.traveler', function () {
                    updateCounts();
                });
                                ...
                                <div class="tab-pane fade show active" id="oneway-pane" role="tabpanel">
                                    <form class="row g-3 align-items-end flight-form-fields">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <input type="text" id="mobile_code1" class="form-control" placeholder="Phone Number" name="name" />
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-12">
